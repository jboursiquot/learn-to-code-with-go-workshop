...
Head over to [https://gobyexample.com](https://gobyexample.com) and click on the first link, _"_[_Hello World_](https://gobyexample.com/hello-world)".  On each example page, you will see a description on the left and code examples on the right.
